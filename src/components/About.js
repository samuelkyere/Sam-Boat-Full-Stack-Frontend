...
function About() {
    return(
        <div className='ab'>
            ...
            <p> We here at SamBoat Ventures are very customer-obsessed and work daily and always to see to it that our customers have the best of experience </p>
            <p> Prices of goods and services are very affordable and covers a wide range so that everyone's need is met at a cost that is afordable to him or her.</p>
            <p> Our workers also have a great experience with great benefit plans. Excellence is our goal which is why our theme or motto is: 'Higher than the Highest'</p>
